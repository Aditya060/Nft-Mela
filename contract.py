...
#creating scenario and accounts to test
def test():
...
#creatin instance of token contract and pass required parameters- FA2 config, Admin Address, Metadata
...
class Marketplace(sp.Contract):
    ...
    def test():
        ...
        sp.add_compilation_target("mark", Marketplace(sp.address("KT1B4Mw4C76A8WgUfEFN2vax6X5tKRg72GcH"), sp.utils.metadata_of_url("ipfs://QmW8jPMdBmFvsSEoLWPPhaozN6jGQFxxkwuMLtVFqEy6Fb"), sp.address("tz1dB1saWuSput2kNQHZPwcK8soFktx8ozYm")))